  ...
  head: () => ({
    meta: [
      ...
      { title: "Grace Library — Free Christian Books, Courses & Gospel Radio" },
      {
        name: "description",
        content:
          "Read free Christian books, watch teaching courses, listen to gospel radio and join the community.",
      },
      { property: "og:title", content: "Grace Library" },
      {
        property: "og:description",
        content: "Free Christian books, courses, gospel radio and fellowship.",
      },
